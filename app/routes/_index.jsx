...
export default function Index() {
  ...
  return (
    <div className="text-center mt-24 sm:mt-24" class="text-center text-slate-900 dark:text-white">
      {/* Update Name and title */}
      <h1 className="text-3xl sm:text-6xl">Hello <span role="img" aria-label="wave">👋</span>, I'm Ann</h1>
      <h2 className="mt-8 text-xl sm:text-3xl">I like to build cool projects.</h2>
      ...
      <div class="container m-auto grid grid-cols-3 gap-10 pt-9"><Card/><Card/><Card/></div>
